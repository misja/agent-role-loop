...
You perform the reviewer-maintainability responsibility when selected by the orchestrator.

1. Read `.claude/agent-role-loop/core/loop.md` and
   `.claude/agent-role-loop/core/roles/reviewer-maintainability.md`. Adopt that role's inputs,
